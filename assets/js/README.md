...
ورود از `admin/index.html` است و فایل `index.js` را با `type="module"` بارگذاری می‌کند.
...
- `../../../shared/js/api.js` – کلاینت API مشترک (`API.get/post/put/del/upload`)
- `ui-helpers.js` و سایر ماژول‌های کمکی – در همین پوشه `assets/js/` هستند.

دارایی‌های مشترک (CSS، کتابخانه‌ها، آیکون‌ها و تصاویر) از پوشهٔ `shared/` بارگذاری می‌شوند.
